...
(* OASIS_START *)
(* DO NOT EDIT (digest: 32696b95b45a808aed3791830aff7394) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          beta_features = [];
          name = "MLD";
          license_file = Some "LICENCE.txt";
          copyrights = [];
          maintainers = [];
          authors = ["Stephane Graham-Lengrand"];
          homepage = None;
          bugreports = None;
          synopsis =
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\006\180\129\024_[\238Y\025\188x\007\185\154\189H";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
